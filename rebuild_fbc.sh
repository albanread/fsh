...
#
# rebuild_fbc.sh
# Rebuild the FasterBASIC compiler (fbc) with timer event support
#

set -e

echo "=== Rebuilding FBC Compiler with Timer Support ==="
echo ""
...
echo ""
echo "=== Build Complete ==="
echo "New compiler: $SCRIPT_DIR/fbc_new"
echo ""
echo "Test with:"
echo "  ./fbc_new test_timers.bas -o test_timers.lua"
echo ""
